...
def sample_segments() -> list[MockSegment]:
    ...
    return [
        MockSegment(
            0.0, 12.5, "Alice", "Good morning everyone, let's get started with the sprint review."
        ),
        MockSegment(
            12.5,
            28.0,
            "Bob",
            "Sure. So last week I finished the authentication module and started on the dashboard.",
        ),
        MockSegment(
            28.0,
            45.3,
            "Alice",
            "Great. Can you walk us through the changes? Let me share my screen so we can look at this together.",
        ),
        MockSegment(
            45.3,
            62.1,
            "Bob",
            "As you can see, the login flow now supports OAuth and we added rate limiting.",
        ),
        MockSegment(
            62.1,
            80.0,
            "Carol",
            "I have a question about the rate limiting. What happens when the limit is exceeded?",
        ),
        MockSegment(
            80.0,
            95.5,
            "Bob",
            "Good question. We return a 429 status code with a Retry-After header.",
        ),
        MockSegment(
            95.5,
            110.0,
            "Alice",
            "Perfect. Let's move on to the next item. Carol, can you give us an update on the API redesign?",
        ),
        MockSegment(
            110.0,
            130.0,
            "Carol",
            "Yes. I've refactored the endpoints to follow REST conventions. Here is the new schema.",
        ),
    ]
